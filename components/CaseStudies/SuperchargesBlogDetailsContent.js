            ...
            <div className="col-lg-8 col-md-12">
              <div className="blog-details">
                ...
                <div className="article-content">
                  ...
                  <p>After reviewing the Figma and engineering spec provided by Sharpz, the we created more specific specs for each feature, focusing on the UI first. This helped to structure the work we requested from ChatGPT.</p>
                  <p>The ultimate approach we landed on was to have ChatGPT generate single files of code that could be incorporated into the broader project one at a time. This still allowed to develop rapidly while also giving us the ability to check that each file or set of files added resulted in the desired outcome. These files would then be connected to other elements of the project as they were developed. Obviously this method does require an engineer, and still requires a moderate amount of manual coding, but dramatically speeds up development.</p>


                  <h3>Outcomes</h3>
                  <p>The results were promising. ChatGPT was able to produce React Native code that compiled nearly every time. About 80% of the time this code did require tweaking to actually achieve the desired outcomes, usually around runtime issues related to UI. However, even with the needed modifications, the process led to a significant acceleration in development time.</p>
                  <p>Compared to the original estimates for project completion, Triosource found that using ChatGPT led to a 5x speed increase in development time. In particular, when focusing on UI work, we saw an outstanding 16x speed increase.</p>


                  <h3>Conclusion</h3>
                  <p>Triosource's approach to the Sharpz React Native app development illustrates the potential for AI in software development. The use of AI tools like ChatGPT can significantly decrease dev times, even when some human input is required. In our personal opinions, we think AI will be generating a significant amount of code over the next 5 years, but most of that code will still need to be human edited.</p>
                </div>
